...
@Component({
  ...
  templateUrl: './analysis2-events.component.html',
  styleUrls: ['./analysis2-events.component.scss']
})
export class Analysis2EventsComponent implements OnInit {
  ...
  activeTab: string = EAnalysis2TypesEnum.topgenerationtemplates;
  chartValue;
  highchartData: any[] = [{
    name: 'Maximum',
