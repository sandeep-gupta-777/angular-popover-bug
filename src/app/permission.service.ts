...
export class PermissionService {
  ...
  private static allBackEndActionsToFrontEndTabMapping2 = {
    ...
    [EAllActions['Get Router Logic']]:true,
    [EAllActions['Update Router Logic']]:true,
    [EAllActions['Create task bot Corpus']]:true,
    [EAllActions['Get task bot Corpus']]:true,
    [EAllActions['Create entity']]:true,
    [EAllActions['Update entity']]:true,
    [EAllActions['Remove entity']]:true,
    [EAllActions['Make trained model live']]:true,
    [EAllActions['Create intent']]:true,
    [EAllActions['Update intent']]:true,
    [EAllActions['Remove intent']]:true,
    [EAllActions['Get default task bot corpus']]:true,
    [EAllActions['Train task bot']]:true,
    [EAllActions['Get default responses']]:true,
    [EAllActions['Get entities']]:true,
    [EAllActions['Get intents']]:true,
    [EAllActions['Make responses live']]:true,
    [EAllActions['Update responses']]:true,
  };
